...
class MLP:
    ...
    def evaluate_loo(self, X, y):
        ...
        for train_index, test_index in loo.split(X):
            ...
            self.train(X_train, y_train, epochs=1525, learning_rate=0.225)
...
mlp.train(X_train, y_train, epochs=1525, learning_rate=0.225)
...
print("Desviación Estandar:", lko_std_deviation)
print("leave-one-out")
print("Error Esperado:", loo_error)
print("Promedio:", loo_avg_accuracy)
print("Desviacion Estandar:", loo_std_deviation)
...
for i in range(len(predictions)):
    ...
    print(f"{i+1}: Prediccion={species_pred}, Especie real={species_real}")
